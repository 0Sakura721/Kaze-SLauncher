...
（欢迎贡献截图！截图请放在 `docs/images/` 目录下，提交 PR 即可）
...
欢迎提交 [Issue](https://github.com/0Sakura721/Kaze-SLauncher/issues) 和 [Pull Request](https://github.com/0Sakura721/Kaze-SLauncher/pulls)！
