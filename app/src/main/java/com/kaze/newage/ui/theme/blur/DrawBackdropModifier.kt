...
import com.kaze.newage.ui.theme.blur.highlight.Highlight
import com.kaze.newage.ui.theme.blur.highlight.drawHighlight
import com.kaze.newage.ui.theme.blur.internal.DOWNSAMPLE_2X_SHADER
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.DOWNSAMPLE_4X_SHADER
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.NOISE_DITHER_SHADER
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.ShapeProvider
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.chain
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.createProgressiveSharpOverlayEffect
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.createProgressiveStackEffect
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.progressiveLoopTapBound
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.progressiveSharpBandBounds
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.progressiveSharpLoopRadius
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.recordLayer
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
import com.kaze.newage.ui.theme.blur.internal.runtimeShaderEffect
import com.kaze.newage.ui.theme.shader.isRuntimeShaderSupported
...
private class DrawBackdropNode(
    ...
    private fun DrawScope.renderBlurInto(target: LevelTarget) {
        ...
        if (scaleFactor <= 1) {
            ...
            recordLayer(this@DrawBackdropNode, layer, size = IntSize(fullWidth, fullHeight)) { recordBackdrop(target) }
            layer.topLeft =
            ...
            recordLayer(this@DrawBackdropNode, layer, size = IntSize(w, h)) { recordBackdrop(target) }
            drawUpscaledLayer(
                target,
                layer,
                scaleFactor.toFloat(),
            ...
            recordLayer(this@DrawBackdropNode, firstCascade, size = IntSize(firstW, firstH)) { recordBackdrop(target) }
    ...
    private fun DrawScope.drawSharpOverlay() {
        ...
        recordLayer(this@DrawBackdropNode, layer, size = bandSize) {
    ...
    private fun DrawScope.applyDownsampleStep(
        ...
        recordLayer(this@DrawBackdropNode, dest, size = IntSize(destW, destH)) {
